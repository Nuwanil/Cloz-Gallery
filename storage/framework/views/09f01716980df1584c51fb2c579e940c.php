...
<html>
      ...
      <div class="hero_area">
         ...
         <div style="margin-bottom: 50px; display: flex; justify-content: center; align-items: center; height: 80vh;">
            <div class="card">
                ...
                <img src="product/<?php echo e($product->image); ?>" alt="Product Image" style="max-width: 100%; max-height: 70vh;">

                </div></div>
                <div class="card-title">
                    Product : <?php echo e($product->title); ?>

                </div>
                <div class="card-subtitle">
                    Product description : <?php echo e($product->description); ?>
                ...
                <div class="card-footer">
                            <?php if($product->discount_price != null): ?>
                                <div style="margin-top: 10px;">
                                    <h6 style="color: red; display: inline;">Discount Price Rs.<?php echo e($product->discount_price); ?>.00</h6>
                                    <span style="margin: 0 10px;">|</span>
                                    <h6 style="text-decoration: line-through; color: blue; display: inline;">Price Rs.<?php echo e($product->price); ?>.00</h6>
                                </div>
                            <?php else: ?>
                                <h6 style="color: blue; margin-top: 10px;">Price Rs.<?php echo e($product->price); ?>.00</h6>
                            <?php endif; ?>
 ...
 <?php /**PATH G:\laravel\Cloz-Gallery\resources\views/home/product_details.blade.php ENDPATH**/ ?>