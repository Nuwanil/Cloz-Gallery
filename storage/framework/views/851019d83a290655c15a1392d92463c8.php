        ...
        <table class="table table-dark text-align:center;  center gray-table" >
            ...
            <?php $totalproduct=0;  ?>
                ...
                <tr class="td">
                    ...
                    <td>Rs.<?php echo e($cart->price); ?>.00</td>
                    <td><img class="img_cart" src="/product/<?php echo e($cart->image); ?>"></td>
                    <td>
                        <a class="option1" onclick="return confirm('Are you sure to remove this product>')" 
                        href="<?php echo e(url('remove_cart',$cart->id)); ?>">Remove</a>
                    </td>
                </tr>
            ...
            <div class="">
                <h1 class="total_cart">Total Price: Rs. <?php echo e($totalprice); ?>.00</h1>
            </div>
            <div style="text-align: center;">
                <h2 style="font-size:25px; padding-bottom:2px;">Proceed to Order</h2>
                <a href="<?php echo e(url('cash_order', $totalproduct)); ?>" class="option1">Cash on Delivery</a>
                <a href="<?php echo e(url('stripe',$totalprice)); ?>" class="option1">Pay using a Card</a>
            </div>
...
<?php /**PATH G:\laravel\Cloz-Gallery\resources\views/home/showcart.blade.php ENDPATH**/ ?>